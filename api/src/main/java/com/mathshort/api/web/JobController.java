...
public class JobController {
    ...
    public Map<String, Object> createJob(@RequestPart("file") MultipartFile file) throws Exception {
    ...
    public ResponseEntity<Resource> getVideo(@PathVariable String jobId) throws Exception {
        UUID id = UUID.fromString(jobId);
        Job job = jobRepository.findById(id).orElseThrow();
